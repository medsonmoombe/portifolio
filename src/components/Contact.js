    ...
    <>
      <section className="bg-slate-800 w-5/5 flex flex-col pt-35 h-screen w-full">
        ...
        <div className="flex m-auto w-5/5 gap-4 sm:flex-col">
          <div className="icon-sec bg-cyan-800 w-2/5 sm:w-3/5 sm:h-50  m-auto rounded">
          ...
          >
            ...
            <input type="text" name="name" placeholder="name" className="outline-none bg-gray-700 border-b-2 border-amber-700 mb-2 text-sm text-cyan-700 ml-2" required />
            <input type="email" name="email" placeholder="email" required className="outline-none bg-gray-700 border-b-2 border-amber-700 mb-2 text-sm text-cyan-700 ml-2" />
            <textarea
              ...
              required
            ></textarea>
            <button type="submit" className="flex justify-start w-fit ml-2 bg-cyan-600 hover:bg-amber-600 text-white  py-1 px-2 mt-4 rounded hover:bg-amber-600  hover:text-white transition duration-150 ease-out hover:ease-in sm:py-1 sm:px-4 sm:text-xs">
              Get in touch
            </button>
          </form>
        </div>
