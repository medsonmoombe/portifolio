  ...
  return (
    <>
      <section className="bg-slate-800 w-5/5 flex flex-col pt-35 h-screen w-full gap-8 items-center">
        ...
        <div className=" w-4/5 sm:h-[250px] md:h-[400px] flex flex-col  flex justify-center items-center pt-2  sm:mt-3  sm:rounded-full">
          <img
            whileHover={{ scale: 1.2 }}
            src={img}
            alt="profile image"
            className="w-60 h-60 sm:w-60 h-80 sm:ml-auto m-auto sm:m-auto sm:mt-0 md:mt-0 sm:rounded-full rounded-full border-8 border-cyan-600"
          />
        </div>
        <div className="pt-2">
        ...
        <div className="flex gap-3 mb-0  ml-42  w-3/5 ">
          <a
            href="#"
